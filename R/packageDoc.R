...
#' if they have a similar expression profile. The similarity between the
#' expression profile of two sample is computed using a method similat to GSEA.
#' The graph of samples can the be used to perform community clustering or to
