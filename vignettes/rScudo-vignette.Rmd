...
cross-validation, in the case of the multigroup analysis previously performed.
Since feature selection represents a performance bottleneck, we perform it
before the cross-validation. Notice that we also transpose the dataset, since
functions in `caret` expect features on columns and samples on rows.
