...
`r CRANpkg("igraph")` to perfor clustering of our network. In Cytoscape we can
...
only on stages B1, B2 and B3, since they have an adeguate numerosity.
...
classStage <- scudoClassify(ALLB[, inTrain], ALLB[, -inTrain], 0.2, 100, 100,
