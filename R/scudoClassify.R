...
#' network of samples generated by SCUDO during a training step, using a method
#' based on neighbors.
#'
...
#' scores are generated dividing them for their sum, obtaining values bewteen 0
#' and 1.
#'
...
#' different group using \code{\link{scudoTrain}} and
