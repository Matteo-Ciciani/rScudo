...
#' \code{\link{scudo}} and \code{\link{scudoTest}}.
#'
#' This class provides a structure to represent the results of \code{scudo} and
#' \code{scudoTest}. It contains a distance matrix and the gene signatures
#' generated by the SCUDO analysis. It is possible, although not recomended, to
#' manually create instances of this class (see Example below).
#'
